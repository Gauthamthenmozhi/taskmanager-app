...
## 🚀 Live Demo
- **Frontend:** https://taskmanager-app-git-main-gautham4.vercel.app
...
| Backend | Java 19, Spring Boot 3.2, Spring Security |
...
- **MongoDB over MySQL** — Switched to MongoDB Atlas (cloud) to avoid local MySQL setup complexity. Faster to get running.
- **No task ordering** — Tasks are not manually sortable; ordered by creation time.
...
- **JWT in localStorage** — Stored JWT in localStorage for simplicity. In production, HttpOnly cookies would be more secure.
